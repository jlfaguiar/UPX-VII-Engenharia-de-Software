...
export const MinhasCaronas = (props) => {
    ...
    const getGruposDeCaronaData = async () => {
        ...
        try {
            ...
            carona_snapshot.data.forEach((doc) => {
                ...
                if (gp_carona.minha_carona || gp_carona.carona_participante) {
    ...
    return (
        <View style={{ flex: 1, alignItems: 'center' }}>
            <Text style={listaGruposDeCaronasStyles.screenTitle}>Minhas Caronas</Text>
